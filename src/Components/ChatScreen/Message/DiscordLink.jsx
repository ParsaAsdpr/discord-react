...
const DiscordLink = ({ link, author }) => {
  ...
  return (
    <div className="py-4 px-3.5 bg-[#2c2e33] rounded-[5px] flex flex-col mt-0.5">
      ...
      <div className="flex gap-1 items-center pt-4">
        ...
        />
        <div className="flex flex-col pr-[70px] justify-center">
          <p
            className={`${
          ...
          <p className="text-[13px] text-[#aaaaaa]">
            {invite ? (
              ...
              `Ask ${author.name} for a new invite!`
            )}
          </p>
        </div>
        <button
