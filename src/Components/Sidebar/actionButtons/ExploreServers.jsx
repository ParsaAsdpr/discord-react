  ...
  return (
    <>
      <div
        ...
        } side-icon hover:bg-[#3BA55D] text-white cursor-pointer py-3 px-2.5 w-full duration-200 relative flex justify-center items-center`}
        onClick={handleClick}
      ...
      >
        ...
        {IsShown && <Tooltip name={"Explore Discoverable Servers"} />}
